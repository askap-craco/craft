...
def _main():
    ...
    if values.dm is not None:
        ...
        while True:
            ...
            c1,frqt1 = dmchanof(f1,foff, t1, values.dm)
            c2,frqt2 = dmchanof(f1,foff, t2, values.dm)
            ...
            print 'dm', values.dm, 't', t, c1, c2, t1, t2, frqt1, frqt2
            ...
            tin1 = dmdelay(values.dm, frqt1, fc1-foff/2.) # time spent between the pulse start freq, and bottom of the channel
            tin11 = dmdelay(values.dm, fc1+foff/2., fc1-foff/2.) # Time we could have spent, had the pulse started in the top, rather than the side

            tin2 = dmdelay(values.dm, fc2+foff/2., frqt2)
            tin22 = dmdelay(values.dm, fc2+foff/2., fc2-foff/2.)
